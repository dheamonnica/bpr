...
<body id="page-top">
    ...
    <body>
        ...
        <?php echo form_open(base_url('administrator/pengajuan_kredit/add_save'), array('id' => 'kreditForm')) ?>
        <div class="row p-5">
            <div class="col-lg-12">
                <strong>Nama Lengkap:</strong>
                <input type="text" name="nama_lengkap" id="nama" class="form-control"><br>
            </div>
            <div class="col-lg-12">
                <strong>File KTP:</strong>
                <input type="file" name="pengajuan_kredit_file_ktp_name" id="pengajuan_kredit_file_ktp_name" class="form-control">
            </div>
            <div class="col-lg-12">
                <strong>No HP:</strong>
            ...
            <div class="col-lg-12">
                ...
                <input type="text" name="jumlah_pinjaman" id="jumlah_pinjaman" class="form-control"><br>
            </div>
            <div class="col-lg-12">
                <strong>Jangka Waktu:</strong>
                <input type="text" name="jangka_waktu" id="jangka_waktu" class="form-control"><br>
            </div>
            <div class="col-lg-12">
